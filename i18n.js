...
(function () {
  ...
  var CI_I18N = {
    en: {
      ...
      ci_recover_eyebrow: 'Welcome back', ci_recover_h: 'Pick up your {n}-day streak?', ci_recover_sub: 'You missed {g} days — no judgment. Log today and your streak continues.', ci_recover_cta: 'Continue my streak',
    ...
    pt: {
      ...
      ci_recover_eyebrow: 'Bem-vinda de volta', ci_recover_h: 'Retomar sua sequência de {n} dias?', ci_recover_sub: 'Você ficou {g} dias sem registrar — sem julgamento. Registre hoje e sua sequência continua.', ci_recover_cta: 'Continuar minha sequência',
