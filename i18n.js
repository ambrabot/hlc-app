...
(function () {
  ...
  var WEEK = {
    en: {
      ...
      coach_ins_sleep: "Your Oura sleep score dipped last night. Short sleep nudges up cortisol — your body's built-in alarm hormone — and your hunger signals, so quick-sugar cravings hit by afternoon. A protein-forward breakfast steadies your blood sugar and softens that crash — go gentle and steady today.",
      coach_ins_h: 'A note from your Coach', coach_ins_energy: "A couple of low-energy days. Protein plus steadier carbs at breakfast keeps your blood-sugar curve slower and flatter — fewer spikes, fewer crashes, more even energy — so your morning holds. Here are a couple from your kitchen.", coach_ins_water: "Gentle nudge — you're a little under on water. Even mild dehydration reads to your brain as tiredness and hunger, so a glass now can quiet cravings and ease the afternoon dip.", coach_ins_streak: 'days logged in a row — lovely consistency. Want ideas to keep it feeling fresh?'
    },
    pt: {
      ...
      coach_ins_sleep: 'Seu score de sono do Oura caiu essa noite. Dormir pouco eleva o cortisol — o hormônio de alarme do corpo — e os sinais de fome, e por isso bate vontade de açúcar rápido à tarde. Um café da manhã rico em proteína estabiliza a glicose e suaviza essa queda — vá com calma e firmeza hoje.',
      coach_ins_h: 'Um recado do seu Coach', coach_ins_energy: 'Alguns dias de energia baixa. Proteína com carboidratos mais estáveis no café da manhã deixa a curva de glicose mais lenta e plana — menos picos, menos quedas, energia mais constante — e a manhã se sustenta. Separei um par da sua cozinha.', coach_ins_water: 'Um lembrete gentil — você está um pouco abaixo na água. Mesmo uma desidratação leve o cérebro lê como cansaço e fome, então um copo agora acalma os desejos e alivia a queda da tarde.', coach_ins_streak: 'dias registrados seguidos — que consistência linda. Quer ideias pra manter leve?'
    }
  };
