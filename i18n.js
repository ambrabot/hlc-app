...
(function () {
  ...
  var I18N = {
    ...
    pt: {
      ...
      scan_title: 'Escanear um produto', scan_photo: 'Escanear de uma foto', scan_code: 'Digitar o número', scan_code_go: 'Buscar', scan_code_ask: 'Digite os números impressos embaixo do código de barras.', scan_code_bad: 'Esse número não confere — confira os dígitos.', scan_type: 'Digitar nome', scan_starting: 'Iniciando câmera…', scan_point: 'Aponte para um código de barras ou QR', scan_reading: 'Lendo a foto…', scan_cam: 'Câmera indisponível — escaneie uma foto ou digite o nome.', scan_nofind: 'Nenhum código encontrado na foto. Use a câmera ao vivo ou digite o nome.',
    ...
    it: {
      ...
      scan_title: 'Scansiona un prodotto', scan_photo: 'Scansiona da foto', scan_code: 'Scrivi il numero', scan_code_go: 'Cerca', scan_code_ask: 'Scrivi le cifre stampate sotto il codice a barre.', scan_code_bad: 'Il numero non torna — ricontrolla le cifre.', scan_type: 'Scrivi il nome', scan_starting: 'Avvio fotocamera…', scan_point: 'Inquadra un codice a barre o QR', scan_reading: 'Lettura della foto…', scan_cam: 'Fotocamera non disponibile — scansiona una foto o scrivi il nome.', scan_nofind: 'Nessun codice trovato nella foto. Usa la fotocamera o scrivi il nome.',
    ...
    zh: {
      ...
      scan_title: '扫描产品', scan_photo: '从照片扫描', scan_code: '输入条码数字', scan_code_go: '查询', scan_code_ask: '请输入条形码下方印刷的数字。', scan_code_bad: '该数字校验不通过 — 请重新核对。', scan_type: '输入名称', scan_starting: '正在启动相机…', scan_point: '对准条形码或二维码', scan_reading: '正在读取照片…', scan_cam: '相机不可用——请扫描照片或输入名称。', scan_nofind: '照片中未找到条码或二维码。请使用相机或输入名称。',
    ...
    he: {
      ...
      scan_title: 'סריקת מוצר', scan_photo: 'סריקה מתמונה', scan_code: 'הקלדת המספר', scan_code_go: 'חיפוש', scan_code_ask: 'הקלידי את הספרות המודפסות מתחת לברקוד.', scan_code_bad: 'המספר לא מסתדר — בדקי את הספרות.', scan_type: 'הקלדת שם', scan_starting: 'מפעיל מצלמה…', scan_point: 'כווני אל ברקוד או QR', scan_reading: 'קורא את התמונה…', scan_cam: 'המצלמה לא זמינה — סרקי תמונה או הקלידי שם.', scan_nofind: 'לא נמצא ברקוד או QR בתמונה. נסי מצלמה חיה, או הקלידי שם.',
